...
<head>
    ...
    <title>Them san pham - <?php echo APP_NAME; ?></title>
                    ...
                    <div class="card-body p-4">
                        <div class="info-box">
                            ...
                            <ul class="mb-0" style="font-size: 14px;">
                                <li>Barcode phai la duy nhat trong he thong</li>
                                <li>Gia ban phai lon hon gia nhap de dam bao loi nhuan</li>
                                <li>So luong ton kho mac dinh la 0, ban co the cap nhat sau</li>
                            </ul>
                        </div>
                        ...
                        <form method="POST" action="<?php echo Router::url('products/create.php'); ?>" id="createProductForm">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control" 
                                          ...
                                          name="description" 
                                          rows="4"
                                          placeholder="Mo ta chi tiet ve san pham..."><?php echo Helper::escape($formData['description'] ?? ''); ?></textarea>
                                <small class="form-text text-muted">
