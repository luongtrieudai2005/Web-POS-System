...
<head>
    ...
    <title>Chỉnh sửa nhân viên - <?php echo APP_NAME; ?></title>
        ...
        <div class="col-md-8">
            ...
            <div class="card">
                ...
                <div class="card-header">
                    <h4 class="mb-0">Chỉnh sửa thông tin nhân viên</h4>
                </div>
                ...
                <div class="card-body p-4">
                    ...
                    <form method="POST"
                          action="<?php echo Router::url('users/edit.php?id=' . $user['id']); ?>">
                        ...
                        <div class="mb-3">
                            ...
                            <small class="form-text text-muted">
                                Thay đổi email sẽ thay đổi tên đăng nhập
                            </small>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select <?php echo isset($errors['role']) ? 'is-invalid' : ''; ?>"
                                ...
                                <option value="salesperson"
                                    <?php echo $user['role'] == 'salesperson' ? 'selected' : ''; ?>>
                                    Nhân viên bán hàng
                                </option>
                            ...
                            <?php if ($user['id'] == 1): ?>
                                ...
                                <small class="form-text text-muted">
                                    Không thể thay đổi vai trò admin chính
                                </small>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-select <?php echo isset($errors['status']) ? 'is-invalid' : ''; ?>"
                                ...
                                <option value="locked"
                                    <?php echo $user['status'] == 'locked' ? 'selected' : ''; ?>>
                                    Khóa
                                </option>
                            </select>
                            ...
                            <?php if ($user['id'] == 1): ?>
                                ...
                                <small class="form-text text-muted">
                                    Không thể thay đổi trạng thái admin chính
                                </small>
                            <?php endif; ?>
                        </div>
